    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SubmitSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name.isEmpty()) {
                    Toast.makeText(Screen3Activity.this, "Pleas fill the password field", Toast.LENGTH_SHORT).show();
                } else if (name.equals("Sameh") || name.equals("UlHaq")) {
                    invalid = true;
                    txtalertName.setText("Name Already exist");
                } else if (Pascode.isEmpty()) {
                    Toast.makeText(Screen3Activity.this, "Pleas fill the chainage in working field", Toast.LENGTH_SHORT).show();
                } else if (contact.isEmpty()) {
                    Toast.makeText(Screen3Activity.this, "Pleas fill the crack length field", Toast.LENGTH_SHORT).show();
                } else if (comment.isEmpty()) {
                    Toast.makeText(Screen3Activity.this, "Pleas fill the free text field", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    Toast.makeText(Screen3Activity.this, "User Info \n:" + Colector, Toast.LENGTH_SHORT).show();
                }
        ...
        sp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long l) {
                if (parent.getItemAtPosition(position).equals("Select Country")) {
                    ...
                    Colector += item + "\n";
                    Toast.makeText(Screen3Activity.this, "Selected Country: " + item, Toast.LENGTH_SHORT).show();
                }
            }
